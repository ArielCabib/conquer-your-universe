...
fn App() -> Html {
    ...
    html! {
        ...
        >
            ...
            >
                <div
                    style="display: flex; align-items: center; justify-content: space-between; width: min(80vw, 540px); max-width: 600px; gap: 1rem;"
                >
                    <h1
                        style={format!(
                    ...
                    <button
                        ...
                        style={format!(
                            "display: inline-flex; align-items: center; justify-content: center; width: 3.25rem; height: 3.25rem; border-radius: 50%; border: 1px solid rgba(248, 225, 200, 0.4); background: rgba(0,0,0,0.35); color: {}; cursor: pointer;",
                            ORBIT_03
                        )}
                    >
                        <svg
